        ...
        {loading ? (
          ...
          mine.length === 0 ? (
            <div className="px-6 py-12 text-center">
              ...
              <div className="text-[13px] text-text-faint max-w-[260px] mx-auto leading-[1.6]">If someone scores 3 or below out of 10 on 3 of their recos in the same category, they land here. You can release them manually, or wait for them to send a plea.</div>
            </div>
          ) : (
            mine.map((entry) => (
              <SinBinCard
          ...
          theirs.length === 0 ? (
            <div className="px-6 py-12 text-center">
              ...
              <div className="text-[13px] text-text-faint max-w-[260px] mx-auto leading-[1.6]">If 3 of your recos in the same category score 3 or below, you get sin-binned for that category. Send a plea to ask to be let out — it's up to them.</div>
            </div>
          ) : (
            theirs.map((entry) => (
              <SinBinCard
